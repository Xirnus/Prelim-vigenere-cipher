...
1. Sanitize Inputs:
    - Ensures that both plaintext and key are sanitized to prevent malicious input. The cipher only encodes/decodes string characters
  
2. Limit Data Exposure
    - No user data is being strored or logged.
